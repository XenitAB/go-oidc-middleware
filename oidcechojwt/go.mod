module github.com/xenitab/go-oidc-middleware/oidcechojwt

go 1.17

replace github.com/xenitab/go-oidc-middleware => ../

require github.com/xenitab/go-oidc-middleware v0.0.18
...
require (
	...
	github.com/xenitab/dispans v0.0.10 // indirect
